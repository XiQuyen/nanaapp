...
def search_results(context, search_results):
    ...
    try:
        ...
        return template.loader.render_to_string("includes/search_results.html", context.flatten())
    finally:
        context.pop()
...
def search_result_item(context, search_result):
    ...
    try:
        ...
        return template.loader.render_to_string((
            "includes/search_result_{app_label}_{model_name}.html".format(**params),
            "includes/search_result_{app_label}.html".format(**params),
            "includes/search_result_item.html",
        ), context.flatten())
    finally:
        context.pop()