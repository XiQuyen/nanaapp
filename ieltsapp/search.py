...
def _bulk_save_search_entries(search_entries, batch_size=100):
    ...
    from ieltsapp.models import SearchEntry
    if search_entries:
...
class SearchEngine(object):
    ...
    def _update_obj_index_iter(self, obj):
        ...
        from django.contrib.contenttypes.models import ContentType
        from ieltsapp.models import SearchEntry, get_str_pk
        model = obj.__class__
...
def get_backend(backend_name=None):
    ...
    if not backend_name:
        backend_name = getattr(settings, "WATSON_BACKEND", "ieltsapp.backends.AdaptiveSearchBackend")
